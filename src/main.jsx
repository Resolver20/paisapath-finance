...
function App() {
  ...
  return <Dashboard data={data} save={save} user={user} saving={saving} error={error} />;
}
...
function Dashboard({ data, save, user, saving, error }) {
